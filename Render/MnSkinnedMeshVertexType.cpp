...
MnSkinnedMeshVertexType::MnSkinnedMeshVertexType()
{
	...
	this->AddInputElement(MnInputElement("TEXCOORD", MN_INPUT_ELEMENT_TYPE_FLOAT4, 2), MN_CVF_BONE_INDEX);// bone indices
	this->AddInputElement(MnInputElement("TEXCOORD", MN_INPUT_ELEMENT_TYPE_FLOAT4, 3), MN_CVF_BONE_WEIGHT);// bone weight
}
